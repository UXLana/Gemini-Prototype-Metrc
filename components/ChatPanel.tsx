...
import {
  ...
  AlertTriangle, CheckCircle2, Info, XCircle, ChevronRight, Bot,
} from 'lucide-react';
...
function BannerRenderer({ props, colors }: { props: BannerProps; colors: ReturnType<typeof useAppColors> }) {
  const variants: Record<string, { icon: React.ReactNode; accent: string; bg: string }> = {
    ...
    info: { icon: <Info size={14} />, accent: CHAT_COLORS.primary, bg: CHAT_COLORS.primaryGhost },
  };
          ...
          return (
            <div key={i} className="flex items-center gap-2.5">
              <div
                ...
                style={{
                  backgroundColor: isComplete ? CHAT_COLORS.primary : isCurrent ? CHAT_COLORS.primary : 'transparent',
      ...
      <div ref={scrollRef} className={`flex-1 flex flex-col ${hasMessages ? 'justify-start' : 'items-center justify-center'} px-4 overflow-y-auto`}>
        {!hasMessages ? (
          <div className="flex flex-col items-center">
            ...
            >
              <DotGrid brandColor={CHAT_COLORS.primary} animation={dotAnimation} size="md" />
            </button>
        ...
        >
          ...
          <div className="flex items-center justify-between px-3 pb-2">
            ...
            <button
              ...
              style={{
                backgroundColor: message.trim() ? CHAT_COLORS.primary : isDark ? 'rgba(255,255,255,0.08)' : 'rgba(0,0,0,0.06)',
